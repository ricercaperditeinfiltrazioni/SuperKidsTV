...
// Schermata principale con la griglia dei canali
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Se il timer è scaduto, mostra schermata di blocco
    ...
    final color =
        Color(int.parse('FF${profile.backgroundColor}', radix: 16));
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              // ── Barra di ricerca (solo Kid e Genitore) ──
